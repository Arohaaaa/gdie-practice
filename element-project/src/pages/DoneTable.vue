            ...
            <el-table-column label="状态">
              <template slot-scope="scope">
                <span
                  ...
                  >{{ stateMatchObj[scope.row.status] }}
                </span>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    submitSelect() {
      if (Array.isArray(this.dateRange)) {
        this.sendRequestForTable({
          ...
          completeTimeStart: this.dateRange[0],
          completeTimeEnd: this.dateRange[1],
        });
      } else {
        this.sendRequestForTable({
          typeKey: this.categoryValue,
    ...
    sendRequestForTable({
      ...
      completeTimeStart = Array.isArray(this.dateRange)
        ? this.dateRange[0]
        : undefined,
      completeTimeEnd = Array.isArray(this.dateRange)
        ? this.dateRange[1]
        : undefined,
