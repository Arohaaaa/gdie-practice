<template>
  <div class="wrapper">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
      <el-breadcrumb-item class="font--normal" to="/task">创建任务</el-breadcrumb-item>
      <el-breadcrumb-item class="font--active" to="/task">创建督察任务</el-breadcrumb-item>
    </el-breadcrumb>

    <div class="baseInfo--wrapper">
      <div class="item-title">基本信息</div>
      <div class="baseInfo__subItem" style="margin-top: 16px;">
        ...
        <el-row :gutter="20" style="margin-top:30px">
          <el-col :span="6">
            <div class="title-input-box">
              ...
              <el-input placeholder="请输入内容" readonly class="input--hostUnit"></el-input>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="title-input-box">
              ...
              <el-input placeholder="无" :disabled="true" class="input--meetUnit"></el-input>
            </div>
          </el-col>
        </el-row>
      </div>
    ...
    <div class="baseInfo--wrapper">
      ...
      <div class="baseInfo__subItem">
        ...
        <div class="baseInfo__input--taskContent">
          <textarea type="text" v-model="inputValue" placeholder="请输入标题  (100字以内)" />
        </div>
      </div>
      <div class="baseInfo__subItem">
        <el-row :gutter="20">
          <el-col :span="6">
            <div class="title-input-box">
              ...
              <el-select filterable value="梅州调研" placeholder="请选择"></el-select>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="title-input-box">
          ...
          <el-col :span="6">
            <div class="title-input-box">
              <span class="baseInfo__subItem-title">分管领导</span>
              <el-select filterable value="徐睿生" placeholder="请选择"></el-select>
            </div>
          </el-col>
        </el-row>
      </div>
      <div class="baseInfo__subItem">
        <span class="baseInfo__subItem-title">任务内容</span>
        <div class="baseInfo__input--taskContent">
          <textarea type="text" v-model="textareaValue" placeholder="请输入任务内容  (500字以内)" />
        </div>
      </div>
      <div class="baseInfo__subItem">
        <span class="baseInfo__subItem-title">相关文件</span>
        ...
        <ul class="addition__list">
          <li class="addition__list-item">
            <div class="addition__list--left">
              ...
              <span
                class="addition__item-title addition__item-title--uploading"
          ...
          <li class="addition__list-item">
            <div class="addition__list--left">
              <i class="addition__file--pdf">P</i>
              <span class="addition__item-title">会议纪要[2018]6号：专题会议纪要（研究部署安全生产….pdf</span>
      ...
      <div class="addItem--box">
        <div v-if="subTaskCom.length == 0" class="addItem--placeholder">
          <div class="addItem-img--wrapper">
            <img src="../assets/img/任务.png" alt="子任务" class="addItem__placehoder" />
          </div>
        ...
        <div v-else class="addItem">
          ...
          <button class="addItem__btn addItem__btn--added" @click="addTask">添加子任务</button>
          <span class="addItem__tips--added">
            <img class="addItem__tips-icon" src="../assets/img/提示.png" />最多可添加10个子任务
          </span>
        </div>
      </div>
    </div>
    <div class="copy--wrapper">
      ...
      <div class="copy__select-box">
        ...
        <input type="text" class="copy__select-input" placeholder="选择后将于此处显示已选人员信息" />
      </div>
    </div>
